...
class Editor:
    ...
    def __init__(self, master):
        ...
        self.root.config(bg="#00008B")
        self.root.resizable(width="False", height="False")
        self.root.title("PYTHON TEXT EDITOR")
        self.root.geometry('400x800+1520+40')
        # canvas = Canvas(self.conv, height=800, width=700, bg="white")

        self.frame = Frame(self.root)
        self.add_widgets()
        self.first_open("model.py")
